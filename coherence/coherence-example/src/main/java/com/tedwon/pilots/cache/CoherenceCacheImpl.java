 ...
 * @since 1.0
 */
public class CoherenceCacheImpl<K, V> implements Cache <K, V> {

    private NamedCache spCache;

    public CoherenceCacheImpl() {
    }

    public CoherenceCacheImpl(NamedCache spCache) {
