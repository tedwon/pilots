 ...
 * @since 1.0
 */
public class OSCacheCacheImpl<K, V> implements Cache<K, V> {

    private com.opensymphony.oscache.base.Cache spCache;

    public OSCacheCacheImpl() {
    }

    public OSCacheCacheImpl(com.opensymphony.oscache.base.Cache spCache) {
    ...
    public V get(Object key) {
        Object value = null;
        try {
            value = spCache.getFromCache("" + key);
