 ...
 This will deploy two artifacts, target/jboss-web.war and
 default-ds.xml.
 ...
 Now you can either deploy the target/jboss-web.war through the
 web-based GlassFish admininstration console, or you can again use asadmin:

  ./asadmin deploy target/jboss-web.war

 To undeploy the application, run:

  ./asadmin undeploy jboss-web
