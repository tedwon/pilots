 ...
 * @author <a href="mailto:gluck@gregluck.com">Greg Luck</a>
 */
public class JGroupsReplicationTCPTest {
    ...
    public void setUp() throws Exception {
        ...
        manager1 = new CacheManager(ClassLoaderUtil.getStandardClassLoader().getResource("ehcache-distributed-jgroups-tcp.xml"));
        manager2 = new CacheManager(ClassLoaderUtil.getStandardClassLoader().getResource("ehcache-distributed-jgroups-tcp.xml"));
    ...
    public static void main(String[] args) throws Exception {
        ...
        JGroupsReplicationTCPTest test = new JGroupsReplicationTCPTest();
        test.setUp();
        test.run();
        test.tearDown();
