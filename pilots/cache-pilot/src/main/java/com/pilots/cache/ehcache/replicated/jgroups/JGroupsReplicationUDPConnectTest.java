 ...
 * @author <a href="mailto:gluck@gregluck.com">Greg Luck</a>
 */
public class JGroupsReplicationUDPConnectTest {
    ...
    public void setUp() throws Exception {
        ...
        manager1 = new CacheManager(ClassLoaderUtil.getStandardClassLoader().getResource("ehcache-distributed-jgroups-udp-connect.xml"));
        manager2 = new CacheManager(ClassLoaderUtil.getStandardClassLoader().getResource("ehcache-distributed-jgroups-udp-connect.xml"));
    ...
    public static void main(String[] args) throws Exception {
        ...
        JGroupsReplicationUDPConnectTest test = new JGroupsReplicationUDPConnectTest();
        test.setUp();
        test.run();
        test.tearDown();
