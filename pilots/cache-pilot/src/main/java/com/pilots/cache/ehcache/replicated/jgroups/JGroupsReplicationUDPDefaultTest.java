 ...
 * @author <a href="mailto:gluck@gregluck.com">Greg Luck</a>
 */
public class JGroupsReplicationUDPDefaultTest {
    ...
    public void setUp() throws Exception {
        ...
        manager1 = new CacheManager(ClassLoaderUtil.getStandardClassLoader().getResource("ehcache-distributed-jgroups-udp-default.xml"));
        manager2 = new CacheManager(ClassLoaderUtil.getStandardClassLoader().getResource("ehcache-distributed-jgroups-udp-default.xml"));
    ...
    public static void main(String[] args) throws Exception {
        ...
        JGroupsReplicationUDPDefaultTest test = new JGroupsReplicationUDPDefaultTest();
        test.setUp();
        test.run();
        test.tearDown();
