...
package com.pilots.cache.ehcache.replicated.jgroups;
 ...
 * @author <a href="mailto:gluck@gregluck.com">Greg Luck</a>
 */
public class JGroupsReplicationUDPFileTest {
    ...
    public void setUp() throws Exception {
        ...
        manager1 = new CacheManager(ClassLoaderUtil.getStandardClassLoader().getResource("ehcache-distributed-jgroups-udp-file-manager1.xml"));
        manager2 = new CacheManager(ClassLoaderUtil.getStandardClassLoader().getResource("ehcache-distributed-jgroups-udp-file-manager2.xml"));
    ...
    public static void main(String[] args) throws Exception {
        ...
        JGroupsReplicationUDPFileTest test = new JGroupsReplicationUDPFileTest();
        test.setUp();
        test.run();
        test.tearDown();
