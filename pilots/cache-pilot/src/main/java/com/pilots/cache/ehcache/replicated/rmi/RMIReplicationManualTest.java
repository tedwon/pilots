 ...
 * @author <a href="mailto:gluck@gregluck.com">Greg Luck</a>
 */
public class RMIReplicationManualTest {
    ...
    public void setUp() throws Exception {
        ...
        manager1 = new CacheManager(ClassLoaderUtil.getStandardClassLoader().getResource("ehcache-distributed-rmi-manual-1.xml"));
        manager2 = new CacheManager(ClassLoaderUtil.getStandardClassLoader().getResource("ehcache-distributed-rmi-manual-2.xml"));
    ...
    public static void main(String[] args) throws Exception {
        ...
        RMIReplicationManualTest test = new RMIReplicationManualTest();
        test.setUp();
        test.run();
        test.tearDown();
