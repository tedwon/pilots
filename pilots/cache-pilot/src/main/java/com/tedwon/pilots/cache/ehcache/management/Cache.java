...
package com.tedwon.pilots.cache.ehcache.management;
 ...
 * @author Greg Luck
 * @version $Id: Cache.java 3665 2011-02-18 19:21:53Z lorban $
 * @since 1.3
 */
public class Cache implements CacheMBean, Serializable {
    ...
    */
    ...
    public String get(String key) throws IllegalStateException, CacheException {
