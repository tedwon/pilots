...
public final class CacheTestUtilities {
    ...
    public static final URL ASYNC_CONFIG_URL1 =
            ClassLoaderUtil.getStandardClassLoader().getResource("jgroups/ehcache-distributed-jgroups-file-manager1.xml");
    /**
     * Config file 2
     */
    public static final URL ASYNC_CONFIG_URL2 =
            ClassLoaderUtil.getStandardClassLoader().getResource("jgroups/ehcache-distributed-jgroups-file-manager2.xml");
    /**
     * Config file 3
     */
    public static final URL ASYNC_CONFIG_URL3 =
            ClassLoaderUtil.getStandardClassLoader().getResource("jgroups/ehcache-distributed-jgroups-file-manager3.xml");
    /**
     * Config file 4
     */
    public static final URL ASYNC_CONFIG_URL4 =
            ClassLoaderUtil.getStandardClassLoader().getResource("jgroups/ehcache-distributed-jgroups-file-manager4.xml");
