 ...
 * @author <a href="mailto:gluck@gregluck.com">Greg Luck</a>
 */
public class JGroupsReplicationConnectTest {
    ...
    public void setUp() throws Exception {
        ...
        manager1 = new CacheManager(ClassLoaderUtil.getStandardClassLoader().getResource("distribution/jgroups/ehcache-distributed-jgroups-connect.xml"));
        manager2 = new CacheManager(ClassLoaderUtil.getStandardClassLoader().getResource("distribution/jgroups/ehcache-distributed-jgroups-connect.xml"));
    ...
    public static void main(String[] args) throws Exception {
        ...
        JGroupsReplicationConnectTest test = new JGroupsReplicationConnectTest();
        test.setUp();
        test.run();
        test.tearDown();
