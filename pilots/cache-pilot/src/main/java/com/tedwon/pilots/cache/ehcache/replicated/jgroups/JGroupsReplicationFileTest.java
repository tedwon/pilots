 ...
 * This test works properly in version 1.5-SNAPSHOT only.
 *
 * @author <a href="mailto:gluck@gregluck.com">Greg Luck</a>
 */
public class JGroupsReplicationFileTest {
    ...
    public void setUp() throws Exception {
        ...
        manager1 = new CacheManager(ClassLoaderUtil.getStandardClassLoader().getResource("jgroups/ehcache-distributed-jgroups-file-manager1.xml"));
        manager2 = new CacheManager(ClassLoaderUtil.getStandardClassLoader().getResource("jgroups/ehcache-distributed-jgroups-file-manager2.xml"));
    ...
    public static void main(String[] args) throws Exception {
        ...
        JGroupsReplicationFileTest test = new JGroupsReplicationFileTest();
        test.setUp();
        test.run();
        test.tearDown();
