 ...
 */
public class RMICacheReplicatorAutomaticTest {
    ...
    public void process() throws Exception {
        ...
        CacheManager manager1 = new CacheManager(ClassLoaderUtil.getStandardClassLoader().getResource("rmi/ehcache-distributed1.xml"));
        CacheManagerPeerListener cachePeerListener = manager1.getCachePeerListener("RMI");

        CacheManager manager2 = new CacheManager(ClassLoaderUtil.getStandardClassLoader().getResource("rmi/ehcache-distributed2.xml"));
    ...
    public static void main(String[] args) throws Exception {
        RMICacheReplicatorAutomaticTest test = new RMICacheReplicatorAutomaticTest();
        test.process();
    }
}
