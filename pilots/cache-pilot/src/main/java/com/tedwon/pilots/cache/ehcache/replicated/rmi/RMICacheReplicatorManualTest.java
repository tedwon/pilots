 ...
 */
public class RMICacheReplicatorManualTest {
    ...
    public void process() throws Exception {
        ...
        CacheManager manager1 = new CacheManager(ClassLoaderUtil.getStandardClassLoader().getResource("rmi/ehcache-distributed1-rmi-manual.xml"));
        CacheManagerPeerListener cachePeerListener = manager1.getCachePeerListener("RMI");

        CacheManager manager2 = new CacheManager(ClassLoaderUtil.getStandardClassLoader().getResource("rmi/ehcache-distributed2-rmi-manual.xml"));
    ...
    public static void main(String[] args) throws Exception {
        RMICacheReplicatorManualTest test = new RMICacheReplicatorManualTest();
        test.process();
    }
}
