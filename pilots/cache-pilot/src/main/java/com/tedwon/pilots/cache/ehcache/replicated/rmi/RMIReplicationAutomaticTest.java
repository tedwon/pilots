...
public class RMIReplicationAutomaticTest {
    ...
    public void setUp() throws Exception {
        ...
        manager1 = new CacheManager(ClassLoaderUtil.getStandardClassLoader().getResource("rmi/ehcache-distributed-rmi-automatic-40001.xml"));
        manager2 = new CacheManager(ClassLoaderUtil.getStandardClassLoader().getResource("rmi/ehcache-distributed-rmi-automatic-40002.xml"));
