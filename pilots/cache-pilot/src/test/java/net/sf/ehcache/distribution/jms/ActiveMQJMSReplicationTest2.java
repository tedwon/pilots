 ...
 */
public class ActiveMQJMSReplicationTest2 {
    ...
    private static final Logger LOG = Logger.getLogger(ActiveMQJMSReplicationTest2.class.getName());

    protected CacheManager manager1, manager2, manager3, manager4;

    protected String getConfigurationFile() {
        return "jms/ehcache-distributed-jms-activemq.xml";
    }
